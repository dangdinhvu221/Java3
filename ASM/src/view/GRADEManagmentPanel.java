...
public class GRADEManagmentPanel extends javax.swing.JPanel {
    ...
    public void fillTable() {
        ...
        this.list.forEach(grade -> {
            this.tblModel.addRow(new Object[]{
                grade.getCodeStudent(), grade.getFullName(), grade.getEnglish(), grade.getInformationtics(), grade.getGDTC(), grade.formatAVG()});
        });
    ...
    public void Save() {
        ...
        try {
            ...
            grade.setCodeStudent(this.txtCodeStudent1.getText().toUpperCase());
            ...
            fillTable();
            MessageDialogHelper.showMessageDialog(this, "thêm dữ liệu vào database thành công", "Thông báo");
            New();
        } catch (Exception e) {
            e.printStackTrace();
            MessageDialogHelper.showErrorDialog(this, "Thêm không thành công!!!", "Thông báo");
        }
    }
    ...
    public void Update() {
        try {
            ...
            e.printStackTrace();
            MessageDialogHelper.showErrorDialog(this, "Cập nhật không thành công!!!", "Thông báo");
        }
    }
    ...
    public void Delete() {
        ...
        try {
            ...
            System.out.println(e + "ok");
            MessageDialogHelper.showErrorDialog(this, "Không có mã nhân viên", "Error");
            return;
        }
        try {
            if (sb.length() > 0) {
...
//                        this.showw(i);
                ...
                this.txtCodeStudent1.setText(st.getCodeStuden());
    ...
    private void showText(GRADE grade) {
    ...
    public void mouseClick() {
        this.index = this.tblShowData.getSelectedRow();
        showw(this.index);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "TÌM KIẾM", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 12))); // NOI18N
        ...
        txtCodeStudent1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        txtInformationtics.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        txtGDTC.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        lblDiemTB.setBackground(new java.awt.Color(0, 255, 153));
        ...
        lblFullname.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        ...
        btnFirst.setBackground(new java.awt.Color(0, 255, 102));
        ...
        btnNext.setBackground(new java.awt.Color(0, 255, 102));
        ...
        btnLast.setBackground(new java.awt.Color(0, 255, 102));
        ...
        tblShowData.setBackground(new java.awt.Color(153, 255, 255));
